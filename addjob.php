<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	VALUES (
	'$curjid',  '0',  '$job_name',  '$amount',  '$cprice',  '$pprice',  '$jobdescription',  '$sday $shour:$sminute:00', '$eday $ehour:$eminute:00',  '$downlink', '$uplink',  '$client',  '$production',  '$manager',  '$msk',  '$alp',  '$cc',  '$ret',  '$vct',  '0',  '0',  '0',  '0',  '0'
	);";
...
<!-- Form Name -->
<legend>Hello, <?php echo $_SESSION['login_user'] ?>, Add new job!</legend>
