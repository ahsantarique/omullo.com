...
?>
	...
	$sql = "SELECT * from jobs where jid not in (SELECT jid from jobs where ul = 0) and (DATE($datetype) >= CAST('$std' AS DATE) AND  DATE($datetype) <= CAST('$end' AS DATE)) and (ccode='$cid'||'$cid'='') and subjid=0 ";
